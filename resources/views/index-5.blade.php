                    ...
                    <div class="row">
                        <div class="col-xl-7">
                            <div class="slide-content slide-content-5  pl-60">
                                ...
                                Coming</h1>
                                <div class="slide-btn">
                                    <a class="btn theme-btn" href="/shop" data-animation="fadeInLeft" data-delay=".8s">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner mb-30">
                        <a href="/shop"><img src="assets/img/banner/banner-5/banner1.jpg" alt=""></a>
                    </div>
                    <div class="banner mb-30">
                        <a href="/shop"><img src="assets/img/banner/banner-5/banner5.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-8 col-md-6">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner mb-30">
                                <a href="/shop"><img src="assets/img/banner/banner-5/banner2.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="banner mb-30">
                                <a href="/shop"><img src="assets/img/banner/banner-5/banner3.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="banner mb-30">
                                <a href="/shop"><img src="assets/img/banner/banner-5/banner4.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-wrapper mb-50">
                        <div class="product-img mb-25">
                            <a href="/product-details">
                                ...
                                <img class="secondary-img" src="assets/img/product/pro15.jpg" alt="">
                            </a>
                            <div class="product-action text-center">
                                <a href="#" title="Shoppingb Cart">
                                    <i class="flaticon-shopping-cart"></i>
                ...
                <div class="pro-item">
                    <div class="product-wrapper mb-50">
                        ...
                        <div class="product-content">
                            ...
                            <h4>
                                <a href="/product-details">Lodge Flush Mount Cloth</a>
                            </h4>
                            <div class="product-meta">
                                <div class="pro-price">
                                    <span>$119.00 USD</span>
                    ...
                    <div class="product-wrapper mb-50">
                        ...
                        <div class="product-content">
                            ...
                            <h4>
                                <a href="/product-details">Bakix Fashion Product Man</a>
                            </h4>
                            <div class="product-meta">
                                <div class="pro-price">
                                    <span>$119.00 USD</span>
                ...
                <div class="pro-item">
                    <div class="product-wrapper mb-50">
                        ...
                        <div class="product-content">
                            ...
                            <h4>
                                <a href="/product-details">Lodge Flush Mount Style</a>
                            </h4>
                            <div class="product-meta">
                                <div class="pro-price">
                                    <span>$119.00 USD</span>
                    ...
                    <div class="product-wrapper mb-50">
                        ...
                        <div class="product-content">
                            ...
                            <h4>
                                <a href="/product-details">Vue Trendy Product Cloth </a>
                            </h4>
                            <div class="product-meta">
                                <div class="pro-price">
                                    <span>$119.00 USD</span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="latest-news mb-40">
                        <div class="news__thumb mb-25">
                            <img src="assets/img/blog/latest/lb8.jpg" alt="">
                        </div>
                        <div class="news__caption white-bg">
                            ...
                            <h2><a href="/blog-details">IInspiration Is Construction
                            Fashion 2019.</a></h2>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="latest-news mb-40">
                        <div class="news__thumb mb-25">
                            <img src="assets/img/blog/latest/lb9.jpg" alt="">
                        </div>
                        <div class="news__caption white-bg">
                            <div class="news-meta mb-15">
                                <span><i class="far fa-calendar-check"></i> Sep 15, 2018 </span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="latest-news mb-40">
                        <div class="news__thumb mb-25">
                            <img src="assets/img/blog/latest/lb10.jpg" alt="">
                        </div>
                        <div class="news__caption white-bg">
                            <div class="news-meta mb-15">
                                <span><i class="far fa-calendar-check"></i> Sep 15, 2018 </span>
                            ...
                            <h2><a href="/blog-details">IIInspiration Is Construction
                            Fashion 2019.</a></h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                            aliqua. Ut enim ad minim veniam.</p>
                        </div>
