            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                    <div class="shop-banner mb-50">
                        <img src="assets/img/bg/shop-banner-2.jpg" alt="">
                    </div>
                    <!-- tab filter -->
                    <div class="row mb-10">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="product-wrapper mb-50">
                                        ...
                                        <div class="product-content pr-0">
                                            ...
                                            <h4>
                                                <a href="/product-details">Minimal Deco Furniture</a>
                                            </h4>
                                    ...
                                    <div class="product-wrapper mb-50">
                                        <div class="product-img mb-25">
                                            <a href="/product-details">
                                                ...
                                                <img class="secondary-img" src="img/product/pro3.jpg" alt="">
                                            </a>
                                            <div class="product-action text-center">
                                                <a href="#" title="Shoppingb Cart">
                                                    <i class="flaticon-shopping-cart"></i>
                                    ...
                                    <div class="product-wrapper mb-50">
                                        <div class="product-img mb-25">
                                            <a href="/product-details">
                                                ...
                                                <img class="secondary-img" src="img/product/pro9.jpg" alt="">
                                            </a>
                                            <div class="product-action text-center">
                                                <a href="#" title="Shoppingb Cart">
                                                    <i class="flaticon-shopping-cart"></i>
                    ...
                    <div class="sidebar-shop">
                            ...
                            <ul class="shop-sidebar-product">
                                <li>
                                    <div class="side-pro-img">
                                        <a href="/product-details"><img src="img/product/latest/shop-rsp3.jpg" alt=""></a>
                                    </div>
                                ...
                                <li>
                                    <div class="side-pro-img">
                                        <a href="/product-details"><img src="img/product/latest/shop-rsp2.jpg" alt=""></a>
                                    </div>
                                    <div class="side-pro-content">
                                        <div class="side-pro-rating">
                                            <i class="fas fa-star"></i>
                                ...
                                <li>
                                    <div class="side-pro-img">
                                        <a href="/product-details"><img src="img/product/latest/shop-rsp4.jpg" alt=""></a>
                                    </div>
                                    <div class="side-pro-content">
                                        <div class="side-pro-rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="shop-widget">
                            <div class="shop-sidebar-banner">
                                <a href="/shop"><img src="img/banner/shop-banner.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
