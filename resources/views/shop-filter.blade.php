                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6">
                                        <div class="shop-widget">
                                            ...
                                            <ul class="shop-link">
                                                <li><a href="/shop">Default sorting</a></li>
                                                <li><a href="/shop"> Sort by popularity</a></li>
                                                <li><a href="/shop"> Sort by average rating</a></li>
                                                <li><a href="/shop"> Sort by newness</a></li>
                                                <li><a href="/shop"> Sort by price: low to high</a></li>
                                                <li><a href="/shop"> Sort by price: high to low</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3">
                                        <div class="shop-widget">
                                            ...
                                            <ul class="shop-link">
                                                <li><a href="/shop"><i class="far fa-square"></i> SM</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> LG</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> MD</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> XS</a></li>
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-3">
                                        <div class="shop-widget">
                                            ...
                                            <ul class="shop-link">
                                                <li><a href="/shop"><i class="far fa-square"></i> Minimal</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> T-Shirts</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> Pants</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> Jeants</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> Winter</a></li>
                                                <li><a href="/shop"><i class="far fa-square"></i> Latest</a></li>
                                            </ul>
                                        </div>
                                    </div>
