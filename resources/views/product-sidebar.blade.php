...
<main>
    ...
    <!-- shop-area start -->
    <section class="shop-details-area pt-100 pb-100 box-90">
                                ...
                                <div class="product-variant">
                                    ...
                                    <div class="product-color variant-item">
                                        ...
                                        <ul class="shop-link shop-color">
                                            <li><a href="/shop"><span class="blue"></span></a></li>
                                            <li><a href="/shop"><span class="green"></span> </a></li>
                                            <li><a href="/shop"><span class="orange"></span> </a></li>
                                            <li><a href="/shop"><span class="navy"></span> </a></li>
                                            <li><a href="/shop"><span class="pinkish"></span> </a></li>
                                            <li><a href="/shop"><span class="vista"></span> </a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="product-size variant-item">
                                        ...
                                        <ul class="shop-link shop-size">
                                            <li><a href="/shop">xxl </a></li>
                                            <li class="active"><a href="/shop">xl </a></li>
                                            <li><a href="/shop">lg </a></li>
                                            <li><a href="/shop">md </a></li>
                                            <li><a href="/shop">sm </a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="product-Metarial variant-item">
                                        ...
                                        <ul class="shop-link shop-size">
                                            <li><a href="/shop">resin</a></li>
                                            <li><a href="/shop">metal </a></li>
                                            <li class="active"><a href="/shop">fiber </a></li>
                                            <li><a href="/shop">slag </a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="row mt-50">
                                            ...
                                            <div class="product-commnets">
                                                <div class="product-commnets-list mb-25 pb-15">
                                                    <div class="pro-comments-img">
                                                        <img src="assets/img/product/comments/01.png" alt="">
                                                    </div>
                                                ...
                                                <div class="product-commnets-list mb-25 pb-15">
                                                    <div class="pro-comments-img">
                                                        <img src="assets/img/product/comments/02.png" alt="">
                                                    </div>
                                                    <div class="pro-commnets-text">
                                                        <h4>Roger West -
                                                            <span>June 5, 2018</span>
                        ...
                        <div class="col-xl-4 col-lg-12">
                            <div class="pro-details-banner">
                                <a href="/shop"><img src="assets/img/banner/pro-details.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="product-wrapper">
                            <div class="product-img mb-25">
                                <a href="/product-details">
                                    ...
                                    <img class="secondary-img" src="assets/img/product/pro5.jpg" alt="">
                                </a>
                            ...
                            <div class="product-content">
                                ...
                                <h4>
                                    <a href="/product-details">Raglan Baseball Style shirt</a>
                                </h4>
                    ...
                    <div class="pro-item">
                        <div class="product-wrapper">
                            <div class="product-img mb-25">
                                <a href="/product-details">
                                    <img src="assets/img/product/pro1.jpg" alt="">
                                    <img class="secondary-img" src="assets/img/product/pro11.jpg" alt="">
                                </a>
                                <div class="product-action text-center">
                                    <a href="#" title="Shoppingb Cart">
                                        <i class="flaticon-shopping-cart"></i>
